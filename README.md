...
| `CRYPTO_FEE_ALLOWANCE` / `CRYPTO_FEE_ALLOWANCE_MAX_PCT` | `eth:0.001,usdt-erc20:5,sol:0.01,usdt-spl:2` / `50` | The withdrawal fee an exchange may have taken *out* of a payment before it stops counting as paid in full, per coin; and the most of a quote that allowance may cover. Whichever of this and the percentage is wider applies |
